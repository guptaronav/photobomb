...
class Photobomb:
    def __init__(self):
        ...
        self.place1Rect = pygame.Rect((self.place1Loc[0]-10,self.place1Loc[0]),(self.place1Size[0]+10,self.place1Size[1]))
        ...
        self.place2Rect = pygame.Rect((self.place2Loc[0]-10,self.place2Loc[0]),(self.place2Size[0]+10,self.place2Size[1]))
        ...
        self.place3Rect = pygame.Rect((self.place3Loc[0]-10,self.place3Loc[0]),(self.place3Size[0]+10,self.place3Size[1]))
        
        self.vicText = self.chalkFont3.render("Choose your victim: ", 1, (green))
        self.vicSize = self.chalkFont3.size("Choose your victim: ")
        ...
        self.vic1Loc = (650, self.buffer + 200)
        self.vic1Rect = pygame.Rect((self.vic1Loc[0]-10,self.vic1Loc[0]),(self.vic1Size[0]+10,self.vic1Size[1]))
        ...
        self.vic2Loc = (900, self.buffer + 200)
        self.vic2Rect = pygame.Rect((self.vic2Loc[0]-10,self.vic2Loc[0]),(self.vic2Size[0]+10,self.vic2Size[1]))
        ...
        self.vic3Loc = (1100, self.buffer + 200)
        self.vic3Rect = pygame.Rect((self.vic3Loc[0]-10,self.vic3Loc[0]),(self.vic3Size[0]+10,self.vic3Size[1]))
        self.start_up_init()
    ...
    def start_up_init(self):
        ...
        self.playButtonLoc = (WIDTH/2 - self.playButtonSize[0]/2, HEIGHT/2 - self.playButtonSize[1]/2)
    ...
    def select_loc_and_victim(self):
        ...
        SCREEN.blit(self.vicText,(200,self.vic1Loc[1]))
